...
description: Repurpose one source into platform-native versions for Xiaohongshu, WeChat, Bilibili, Douyin, LinkedIn, X, newsletters, and blogs. Use when the user asks for platform repurpose or content creator workflow support.
---
...
Use upstream repurposing workflow. Preserve the core idea while rewriting structure, tone, length, CTA, and compliance for each target platform.
